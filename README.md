...
```
cd existing_repo
git remote add origin https://gitlab.com/davidbester/recipes-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/davidbester/recipes-app/-/settings/integrations)
